...
import com.stockhawk.ui.DetailsActivity;
import com.stockhawk.ui.MainActivity;
...
public class StockWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int widgetId : appWidgetIds) {
            ...
            remoteViews.setInt(R.id.widget_list, "setBackgroundResource", R.color.backGraound);
            remoteViews.setInt(R.id.widget_content, "setBackgroundResource", R.color.backGraound);
